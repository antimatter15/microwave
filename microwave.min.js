...
f.innerHTML="<div style='float:right;color:#555'>"+format_time(b.lastModifiedTime).toString()+e;f.appendChild(userList(b.contributors));if(mobilewebkit){d.onclick=doNothing;f.onclick=doNothing}d.insertBefore(f,d.firstChild);c.appendChild(d);a==chronological_blips[scrollto_position]&&setTimeout(function(){blip_scroll(scrollto_position)},500);return d}}

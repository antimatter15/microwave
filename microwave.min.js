...
function archiveWave(){wave.robot.folderAction("archive",current_wave,current_wavelet);hide_float();runQueue()}window.onresize=document.onscroll=window.onscroll=function(){if(current_page==0)searchscroll=scrollY;document.getElementById("floating_menu").style.top=scrollY+window.innerHeight-50+"px"};mobilewebkit&&setInterval(document.onscroll,1E3);
...
i;else if(g=="conv/title")l.style.fontWeight="bold";else if(g!="spell")if(g!="lang")if(g=="link/manual"||g=="link/auto"){l.href=i;l.target="_blank"}else if(g=="link/wave"){l.href="#wave:"+i;l.setAttribute("onclick","ch(this)")}else g.indexOf("user/e")!=0&&g.indexOf("user/d")!=0&&g.indexOf("user/r")!=0&&console.log("unrecognized annotation",g,i)}}if(c.charAt(e)!="\n")p+=c.charAt(e)}p&&l.appendChild(document.createTextNode(p));return j}var queue=[],callbacks={},id_count=0;

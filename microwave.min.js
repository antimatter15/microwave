...
return f}}function error(a){var c=getEl("error");c.style.display="";getEl("errortext").innerHTML=a;c.onclick=function(){c.style.display="none"}}var lastscrolled="",gstates={};
...
j.appendChild(l)}else if(h.type=="GADGET")j.appendChild(renderGadget(h,a));else h.type!="LINE"&&console.log("unknown element type",h.type,h.properties);l=document.createElement(h.properties.lineType||"p");if(h.properties.indent)l.style.marginLeft=h.properties.indent*20+"px";if(h.properties.alignment)l.style.textAlign={l:"left",c:"center",r:"right"}[h.properties.alignment];h.properties.direction&&l.setAttribute("dir",{l:"ltr",r:"rtl"}[h.properties.alignment]);j.appendChild(l)}if(b[e])for(var n=b[e],

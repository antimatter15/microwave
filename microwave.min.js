...
"</span>":"<span class='read_msg'>"+d.blipCount+" msgs</span>",j=format_time(d.lastModified),k=opt.offline?' <span class="cachestate">cache</span>':"";i='<div id="'+d.waveId+'" class="search '+resultClass(d.waveId)+'"><div class="date">'+j+"<br>"+i+k+'</div><span class="title_'+(d.unreadCount>0?"unread":"read")+'">'+d.title+"</span> <span class='snippet'>"+d.snippet+"</span> </div>";f+='<a href="#wave:'+d.waveId+'" class="searchlink" onclick=\'ch(this)\'>'+i+"</a>"}}search_container.innerHTML+=f;

...
function animated_scroll(a,c){var b=a==window,d=b?pageYOffset:a.scrollTop;if(d!=c){var f=2*Math.sqrt(42*Math.abs(c-d)),e,g=+new Date+f;(e=function(){var h=Math.min(1,1-(g-new Date)/f),i=(c-d)*h+d;if(b)scrollTo(0,i);else a.scrollTop=i;h<1&&setTimeout(e,0)})()}}

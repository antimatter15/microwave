...
function reset_touchscroll(){document.getElementById("wave_container_parent").style.width=innerWidth-250+"px";document.getElementById("wave_container").style.width=innerWidth-250+"px";document.getElementById("search_parent").style.width="250px"}
